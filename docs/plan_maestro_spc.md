...
> Documento vivo. Versión 0.4 (Fase 0, 1 y 2a cerradas; 2a **re-auditada y cerrada definitivamente**: selección movida a VALID, artefacto portable, métrica honesta recursiva como métrica guía). Se actualiza al cierre de cada fase, dejando rastro en el registro de decisiones (ADR).
